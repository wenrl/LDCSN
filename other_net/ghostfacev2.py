...
class GhostFaceNetsV2(nn.Module):
    def __init__(self, cfgs=None, image_size=224, num_classes=10572, width=1.0, channels=3, dropout=0.2,
        ...
        self.conv_dw = nn.Conv2d(960, 960, kernel_size=1, groups=960, bias=False)
        self.bn2 = nn.BatchNorm2d(960)
        self.conv = nn.Conv2d(960, 512, kernel_size=1, bias=False)
