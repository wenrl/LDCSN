...
def load_pretrained1(model, classifier, classifier_ufa, filename='/home/root1/桌面/code/EMHSA-main/warmingup/model_best_fusionnet_CMMHSA_clean_9845_9417_2907.pth.tar'):#model_best_p4_9932_9687_5360.pth.tar
    file = filename
    ...
    if os.path.isfile(file):
        ...
        # model = load_part_params(model, checkpoint['state_dict'], 'ufa')
        model.load_state_dict(checkpoint['state_dict'], strict=False)
        # optimizer.load_state_dict(checkpoint['optimizer'])
        # model.load_state_dict(checkpoint['state_dict'], strict=False)
        classifier.load_state_dict(checkpoint['classifier'])
        # classifier_ufa.load_state_dict(checkpoint['classifier'])
        # model.load_state_dict(checkpoint, strict=True)

        return model, classifier, classifier_ufa
        # return model, classifier

    else:
        logger.info('no checkpoint found at {}'.format(file))
        return model
def load_pretrained(model, classifier, output_dir, filename='/home/root1/桌面/code/EMHSA-main/warmingup/model_best_fusionnet_CMMHSA_clean_9845_9417_2907.pth.tar'):
    file = filename
    if os.path.isfile(file):
        logger.info('load pretrained model from {}'.format(file))
        checkpoint = torch.load(file)
        # print(checkpoint['state_dict'].keys())
        # model = load_part_params(model, checkpoint['state_dict'], 'FCU')
        model.load_state_dict(checkpoint['state_dict'], strict=False)
        # model.load_state_dict(checkpoint['state_dict'], strict=False)
        classifier.load_state_dict(checkpoint['classifier'])
...
#/home/root1/桌面/code/EMHSA-main/output/WebFace/LResNet50E_IR_FPN_CosMargin-Clean/model_best.pth.tar
#/home/root1/桌面/code/EMHSA-main/output/EMHSA_DWConv/UFA/model_best_baseline_EMHSA_clean_9913_9585_3493.pth.tar
#/home/root1/桌面/code/EMHSA-main/warmingup/model_best_p4_blockunit_clean_9937_9645_7197.pth.tar
# /home/root1/桌面/code/EMHSA-main/warmingup/model_best_p5_fusionnet_convMHSA_clean_9903_9518_6700.pth.tar   #CMMHSA
#/home/root1/桌面/code/EMHSA-main/warmingup/model_best_p5_fusionnet_clean_9933_9610_6987.pth.tar             #MMHSA
# /home/root1/桌面/code/EMHSA-main/warmingup/model_best_p4_blockunit_whole_9935_9647.pth.tar
#/home/root1/桌面/code/EMHSA-main/EMHSA_Conv/EMHSA_DWConv_UFA_ConvSAs/fusionnet/model_best_fusionnet_H6_clean_9940_9623_7927.pth.tar
#/home/root1/桌面/code/EMHSA-main/EMHSA_Conv/EMHSA_DWConv_UFA_ConvSAs/fusionnet/model_best_fusionnet_H2_clean_9932_9620.pth.tar
def load_pretrained2(model, classifier, output_dir, filename='/home/root1/桌面/code/EMHSA-main/EMHSA_Conv/EMHSA_DWConv_UFA_ConvSAs/fusionnet/model_best_p5_fusionnet_MHSA.pth.tar'):
    file = filename
    if os.path.isfile(file):
        logger.info('load pretrained model from {}'.format(file))
        checkpoint = torch.load(file)
...
#         # print(np.shape(grid),np.shape(mask))
